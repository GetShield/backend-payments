...
import { RECEIVER_WALLET_ADDRESS, WEBHOOK_SECRET_PRODUCTION,WEBHOOK_SECRET_STAGING,WEBHOOK_URL_PRODUCTION,WEBHOOK_URL_STAGING } from "../const";
...
export const checkTnxStatusController = async (req: Request, res: Response) => {
    ...
    try {
        ...
        const model: any = body.env === 'production' ? tnxProdModel : tnxModel;
